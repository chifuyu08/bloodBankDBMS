...
<body>
	...
	<!-- banner 2 -->
	<div class="backtext">
                    <h1>Thank you <span>for being a part of </span> <b>our journey</b>.</h1>
                    <h1>Thank you <span>for being a part of </span><b>our journey</b>.</h1>
                    <h1>Thank you <span>for being a part of </span><b>our journey</b>.</h1>
                    <h1>Thank you <span>for being a part of </span><b>our journey</b>.</h1>
    </div>
	...
	<div class="agileits-contact py-3">
		...
		<div class="threed-model">
			...
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">fill out the form below to get in touch with us </p>
			</div>
			<div class="d-flex">
				...
				<div class="col-lg-7 contact-right-w3l">
					...
					<form action="#" method="post">
						...
						<div class="form-group">
							<textarea rows="10" cols="100" class="form-control" id="message" name="message" placeholder="MESSAGE" maxlength="999" style="resize:none"></textarea>
						</div>
						<div class="form-group">
